...
export default function FightingForYou() {
  ...
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      <div className="absolute top-20 right-10 w-96 h-96 bg-[#EBB63E]/5 rounded-full blur-3xl" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-[#F18913]/5 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-2 bg-[#EBB63E]/20 text-[#F18913] font-bold text-sm px-4 py-2 rounded-full mb-6">
            ...
            <div className="space-y-6 mb-10">
              {[
                ...
                <motion.div
                  ...
                  className="flex items-center gap-4 bg-gray-50 backdrop-blur-sm rounded-xl p-4 border border-gray-200 hover:bg-gray-100 transition-all duration-300"
                >
          ...
          >
            ...
            {/* Floating stats */}
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-2xl px-6 py-4 border-4 border-gray-100">
            ...
            <div className="absolute -top-6 -right-6 bg-gradient-to-br from-[#EBB63E] to-[#F18913] rounded-2xl shadow-2xl px-6 py-4">
              ...
              <p className="text-[#0C2D5B]/90 text-sm font-medium">Recovered</p>
            </div>
          </motion.div>
        </div>
      </div>
