          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, i) => (
                ...
                >
                  <stat.icon className="w-6 h-6 text-[#F18913] mx-auto mb-2" />
                  <p className="text-2xl font-extrabold text-[#0C2D5B]">{stat.value}</p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-xl px-4 py-3">
                    <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#EBB63E] to-[#F18913]" />
                    <span className="text-[#0C2D5B] font-medium text-sm">{item}</span>
                  </div>
                ))}
              </div>
            </div>
